...
mod tests {
    ...
    use realms::{
        ...
        interfaces::{
            IBridgeDispatcher, IBridgeDispatcherTrait, IUpgradeableDispatcher,
            IUpgradeableDispatcherTrait, IBridgeCollectionAdminDispatcher,
            IBridgeCollectionAdminDispatcherTrait,
        },
    };
    use realms::token::{
        interfaces::{
    ...
    fn deploy_bridge_and_create_collection(
        ...
        let bridge_address = deploy_realms(
    ...
    fn support_two_step_transfer_ownership() {
        ...
        let BRIDGE_L1 = EthAddress { address: 'realms_l1' };
        let ALICE = starknet::contract_address_const::<'alice'>();
        let contract_address = deploy_realms(
            BRIDGE_ADMIN, BRIDGE_L1, erc721b_contract_class.class_hash
        );
    ...
    fn collection_upgrade_as_admin() {
        ...
        start_prank(CheatTarget::One(bridge_address), BRIDGE_ADMIN);
        IBridgeCollectionAdminDispatcher { contract_address: bridge_address }
